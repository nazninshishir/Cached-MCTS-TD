...
class cachedmctstd():
    ...
    def search(self, initialState, needDetails=False):
        ...
        if self.root is None:
            ...
            for action, child in self.bestChild.children.items():
    ...
    def update(self, curStateString, nextStateString, reward):
        ...
        if curStateString in self.states:
            self.states[curStateString] = self.states[curStateString] + self.alpha * (
                        reward + self.gamma * self.states[nextStateString] - self.states[curStateString])
        else:
